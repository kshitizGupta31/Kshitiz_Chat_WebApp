...
export default function Profile() {
  ...
  const validateProfile = () => {
    if (!firstName) {
      toast.error("Firstname Reuired");
      return false;
    }
    if (!lastName) {
      toast.error("Lastname Reuired");
      return false;
    }
    return true;
  };
    ...
    <div className="bg-[#1b1c24] h-[100vh] flex items-center justify-center flex-col gap-10">
      <div className="flex flex-col gap-10 w-[80vw] md:w-max">
        <div onClick={handleNavigate}>
          <IoArrowBack className="text-4xl lg:text-6xl text-white" />
        </div>
        <div className="grid grid-cols-2 ">
          ...
          >
            ...
            {hovered && (
              <div
                className="absolute inset-0 flex items-center justify-center bg-black/50 ring-fuchsia-50 cup rounded-full"
