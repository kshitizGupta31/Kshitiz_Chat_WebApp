    ...
    <>
      ...
      <Dialog open={openNewContactModal} onOpenChange={setOpenNewContactModal}>
        <DialogContent className="bg-[#181920] border-none text-white w-[400px] h-[400px] flex flex-col">
          ...
          {searchedContacts.length <= 0 && (
            <div className="flex-1 md:mt-0 md:bg-transparent md:flex flex-col justify-center mt-4 items-center  duration-1000 transition-all ">
              <Lottie
              ...
              <div className="text-opacity-80 text-white flex flex-col gap-5 items-center mt-6 lg:text-2xl text-xl transition-all duration-300 text-center">
                <h3 className="playfair-display">
                  Hi <span className="text-orange-500">!</span> Search A
                  <span className="text-orange-500"> New</span> Contact
